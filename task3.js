...
$(document).ready(function(){
	...
	// Adds title to the "Selected Hotels" module
	...
	// Creates the list that will hold selected hotels
	$("#hotelNames").append('<ul id="hotelNamesList"></ul>');
	$("#hotelNamesList").css({
	...
	$("a.prominent_button.do_show_rates").click(function(){
		...
		// Checks if the hotel has already beeen added to the list
		if($("#hotelNamesList :contains('"+hotelName+"')").length == 0){
			$("#hotelNamesList").append("<li class='hotelListItem'>"+hotelName+"</li>");
		}
	});
});
